...
to appear---indicating that startup is complete---is the \emph{ds9} window  Then choose an appropriate web interface as shown 
...
\item[pyINDI] \ttblue{git+https://github.com/MMTObservatory/pyINDI.git} \\
\end{description}
